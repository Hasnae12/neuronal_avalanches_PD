...
filename = '/.../.../.../code_linear_regression/figure_paper/panelA.jpg';
resolution = '-r600';
...
yL=ylim;
text(0.99*xL(2),0.98*yL(2),{slope_text, p_value_text}, 'FontSize', 7 ,'BackgroundColor', 'white', 'EdgeColor', 'black','HorizontalAlignment','right','VerticalAlignment','top');
filename = '/.../.../.../code_linear_regression/figure_paper/panelB.jpg';
resolution = '-r600';
print(gcf, filename, '-djpeg', resolution);
...
yL=ylim;
text(0.99*xL(2),0.98*yL(2),{slope_text, p_value_text}, 'FontSize', 7 ,'BackgroundColor', 'white', 'EdgeColor', 'black','HorizontalAlignment','right','VerticalAlignment','top');
filename = '/.../.../.../code_linear_regression/figure_paper/panelC.jpg';
resolution = '-r600';
print(gcf, filename, '-djpeg', resolution);
...
yL=ylim;
text(0.99*xL(2),0.98*yL(2),{slope_text, p_value_text}, 'FontSize', 7 ,'BackgroundColor', 'white', 'EdgeColor', 'black','HorizontalAlignment','right','VerticalAlignment','top');
filename = '/.../.../.../code_linear_regression/figure_paper/panelD.jpg';
resolution = '-r600';
print(gcf, filename, '-djpeg', resolution);
